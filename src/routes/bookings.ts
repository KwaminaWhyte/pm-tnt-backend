...
const bookingRoutes = new Elysia({ prefix: "/api/v1/bookings" })
  ...
  .post("/", async ({ request, body }) => {
    ...
    body: t.Object({
      hotelBooking: t.Optional(t.Object({
        hotelId: t.String(),
      ...
      vehicleBooking: t.Optional(t.Object({
        vehicleId: t.String(),
        pickupDate: t.String(),
        returnDate: t.String(),
      ...
      packageBooking: t.Optional(t.Object({
        packageId: t.String(),
        startDate: t.String(),
        participants: t.Array(t.Object({
          type: t.Union([t.Literal("adult"), t.Literal("child"), t.Literal("infant")]),
          count: t.Number()
        })),
        customizations: t.Optional(t.Array(t.Object({
          type: t.Union([t.Literal("hotel"), t.Literal("activity"), t.Literal("transportation")]),
          itemId: t.String(),
  ...
  .put("/:id", async ({ request, params: { id }, body }) => {
    const bookingController = new BookingController(request);
    ...
    body: t.Object({
      ...
      vehicleBooking: t.Optional(t.Object({
        ...
        pickupLocation: t.Optional(t.Object({
          address: t.String(),
          city: t.String(),
          country: t.String()
        })),
        dropoffLocation: t.Optional(t.Object({
          address: t.String(),
          city: t.String(),
          country: t.String()
        }))
      ...
      packageBooking: t.Optional(t.Object({
        startDate: t.Optional(t.String()),
        participants: t.Optional(t.Array(t.Object({
          type: t.Union([t.Literal("adult"), t.Literal("child"), t.Literal("infant")]),
          count: t.Number()
        })))
      }))
  ...
  .post("/:id/itinerary/progress", async ({ request, params: { id }, body }) => {
    const bookingController = new BookingController(request);
    return bookingController.updateItineraryProgress(id, body.activityId, body.status);
  }, {
    detail: {
      tags: ["Bookings"],
      summary: "Update itinerary progress",
      description: "Update the progress of activities in a booking's itinerary"
    },
    body: t.Object({
      activityId: t.String(),
