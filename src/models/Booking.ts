...
const bookingSchema = new Schema<BookingInterface>(
  {
    ...
    packageBooking: {
      ...
      itinerary: {
        currentDestination: { type: Schema.Types.ObjectId, ref: 'destinations' },
        progress: {
          completedActivities: [{ type: Schema.Types.ObjectId, ref: 'activities' }],
    ...
    status: {
      type: String,
      enum: ['Draft', 'Pending', 'Confirmed', 'InProgress', 'Completed', 'Cancelled'],
      required: true,
      default: 'Draft',
      index: true
    },
